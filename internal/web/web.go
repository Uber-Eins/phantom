// Package web provides the main web server implementation for the phantom panel,
...
import (
	...
	"github.com/Uber-Eins/phantom/v3/internal/util/sys"
	"github.com/Uber-Eins/phantom/v3/internal/web/controller"
	"github.com/Uber-Eins/phantom/v3/internal/web/job"
	"github.com/Uber-Eins/phantom/v3/internal/web/locale"
	"github.com/Uber-Eins/phantom/v3/internal/web/middleware"
	"github.com/Uber-Eins/phantom/v3/internal/web/network"
...
// Server represents the main web server for the phantom panel with controllers, services, and scheduled jobs.
type Server struct {
