...
import (
	...
	xuilogger "github.com/Uber-Eins/phantom/v3/internal/logger"
...
// setupScaleDB initializes SQLite for an opt-in scale benchmark.
func setupScaleDB(t *testing.T) {
	...
	t.Skip("set XUI_SCALE_TEST=1 to run the SQLite scale benchmark")
}
...
// resetScaleTables empties tables between sub-sizes and resets SQLite ids.
