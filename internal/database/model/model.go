// Package model defines the database models and data structures used by the phantom panel.
package model
...
// User represents a user account in the phantom panel.
type User struct {
...
// Setting stores key-value configuration settings for the phantom panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
